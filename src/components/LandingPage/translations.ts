export const translations = {
  en: {
    heroTitle: 'Effortlessly manage and control your reports with FullNext.',
    heroSubtitle: 'Unite your team on a single platform built to manage all your reports.',
    signIn: 'Sign in',
    logIn: 'Log in',
    usersLabel: 'Users',
    ...
    cardTitles: {
      ...
      multiTenancy: "Comprehensive Multi-Tenancy"
    },
    cardDescriptions: {
      customizedAccess: "Define who can access specific reports. Create tailored permissions to ensure users only see what’s relevant to them.",
  ...
  pt: {
    heroTitle: 'Gerencie e controle seus relatórios com facilidade no FullNext.',
    heroSubtitle: 'Unifique sua equipe em uma única plataforma criada para gerenciar todos os seus relatórios.',
    signIn: 'Entrar',
    logIn: 'Fazer login',
    usersLabel: 'Usuários',
    ...
    cardTitles: {
      ...
      completeCustomization: "Personalização Completa",
      costSavings: "Economia de Custos",
      multiTenancy: "Multi-Tenancy Abrangente"
    },
    cardDescriptions: {
      customizedAccess: "Defina quem pode acessar relatórios específicos. Crie permissões personalizadas para garantir que os usuários vejam apenas o que é relevante para eles.",
